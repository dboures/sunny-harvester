...
class MergeMine {
    ...
    newPool({ primaryMint, payer = this.provider.wallet.publicKey, }) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            const [pool, bump] = yield (0, pda_2.findPoolAddress)({
                programId: this.program.programId,
                primaryMint,
            });
            const [replicaMint, mintBump] = yield (0, pda_2.findReplicaMintAddress)({
                programId: this.program.programId,
                primaryMint,
            });
    ...
    getOrCreatePrimary({ mint, pool, mm, payer = this.provider.wallet.publicKey, rewarder, }) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            const [minerKey, minerBump] = yield (0, pda_1.findMinerAddress)(quarryKey, mm);
            const ixs = [];
            ...
            ixs.push(this.program.instruction.initMiner(minerBump, {
                accounts: {
