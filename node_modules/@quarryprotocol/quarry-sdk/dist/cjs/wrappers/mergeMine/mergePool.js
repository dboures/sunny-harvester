...
class MergePool {
    ...
    deposit({ amount, rewarder, mmOwner = this.provider.wallet.publicKey, }) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            const [mmKey, bump] = yield (0, pda_2.findMergeMinerAddress)({
                pool: this.key,
                owner: mmOwner,
            });
            ...
            if (!mmAccount) {
                allInstructions.push(this.program.instruction.initMergeMiner(bump, {
                    accounts: {
                        pool: this.key,
                        owner: mmOwner,
                        mm: mmKey,
    ...
    stakeReplicaMiner(rewarder, mergeMiner) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            const [miner, minerBump] = yield (0, pda_1.findMinerAddress)(quarry, mergeMiner);
            ...
            if (!(yield this.provider.getAccountInfo(miner))) {
                ...
                txEnv.instructions.unshift(this.program.instruction.initMiner(minerBump, {
                    accounts: {
                        pool: this.key,
                        mm: mergeMiner,
                        miner,
    ...
    getPrimaryStakeAccounts(rewarder, mergeMiner) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            return Object.assign(Object.assign({ mm: mergeMiner, rewarder,
                quarry,
                miner,
                minerVault }, this.commonAccounts), { unusedAccount: web3_js_1.Keypair.generate().publicKey });
        });
    }
    get commonAccounts() {
        return {
            ...
            unusedAccount: web3_js_1.Keypair.generate().publicKey,
        };
    }
}
