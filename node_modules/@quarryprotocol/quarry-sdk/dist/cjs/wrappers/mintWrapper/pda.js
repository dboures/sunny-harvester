...
exports.findMinterAddress = exports.findMintWrapperAddress = void 0;
...
const findMinterAddress = (wrapper, authority, programID = constants_1.QUARRY_ADDRESSES.MintWrapper) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    return yield web3_js_1.PublicKey.findProgramAddress([
        Buffer.from(anchor_1.utils.bytes.utf8.encode("MintWrapperMinter")),
        wrapper.toBytes(),
        authority.toBytes(),
    ], programID);
});
exports.findMinterAddress = findMinterAddress;
