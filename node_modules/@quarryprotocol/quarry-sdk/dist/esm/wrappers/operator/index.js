...
export class Operator {
    ...
    static createOperator({ sdk, rewarder, baseKP = Keypair.generate(), admin = sdk.provider.wallet.publicKey, payer = sdk.provider.wallet.publicKey, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const [operatorKey, bump] = yield findOperatorAddress(baseKP.publicKey, sdk.programs.Operator.programId);
            return {
                key: operatorKey,
    ...
    delegateCreateQuarry({ tokenMint, payer = this.sdk.provider.wallet.publicKey, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const [quarry, bump] = yield findQuarryAddress(this.data.rewarder, tokenMint, this.sdk.programs.Mine.programId);
            return {
                quarry,
