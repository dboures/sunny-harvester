...
export class MergePool {
    ...
    deposit({ amount, rewarder, mmOwner = this.provider.wallet.publicKey, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [mmKey, bump] = yield findMergeMinerAddress({
                pool: this.key,
                owner: mmOwner,
            });
    ...
    stakeReplicaMiner(rewarder, mergeMiner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [miner, minerBump] = yield findMinerAddress(quarry, mergeMiner);
    ...
    getPrimaryStakeAccounts(rewarder, mergeMiner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Object.assign(Object.assign({ mm: mergeMiner, rewarder,
                quarry,
                miner,
                minerVault }, this.commonAccounts), { unusedAccount: Keypair.generate().publicKey });
        });
    }
    get commonAccounts() {
        return {
